...
const SEAHORSE_SVG = (
  <svg viewBox="0 0 280 240" className="h-24 w-24 md:h-48 md:w-48">
    <path d="M175 35c22 24 30 55 22 88-4 17-15 31-29 39 5 22-3 42-20 60-13 13-28 19-45 17 19-9 30-23 34-43 4-19 0-36-12-50-16-18-24-39-22-62 2-24 14-45 35-60 23-16 50-14 71 11Z" fill="#D4C5B5" stroke="#4A3F35" stroke-width="4"/>
    <polygon points="115,92 146,68 186,74 198,108 167,127 132,117" fill="#B8A89A" stroke="#4A3F35" stroke-width="4"/>
    <polygon points="102,129 129,108 159,133 143,163 111,156" fill="#C75B5B" stroke="#4A3F35" stroke-width="4"/>
    <polygon points="161,150 189,137 203,160 183,187 154,173" fill="#8B7355" stroke="#4A3F35" stroke-width="4"/>
    <ellipse cx="205" cy="84" rx="18" ry="18" fill="#F5F0E8" stroke="#4A3F35" stroke-width="4"/>
    <circle cx="208" cy="84" r="5" fill="#4A3F35"/>
    <path d="M224 76l20-10-8 21" fill="#D4C5B5" stroke="#4A3F35" stroke-width="4"/>
    <path d="M100 105l-26-8 16 25" fill="#B8A89A" stroke="#4A3F35" stroke-width="4"/>
  </svg>
);
